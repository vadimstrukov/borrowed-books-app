...
export class Constants{
  ...
  public static get LogoutURL():string {return this.API_URL + '/user/logout'}
  public static get LoggedInUser():string{return this.API_URL + '/user/me'}
  public static get Register():string{return this.API_URL + '/register'}
  public static get Books():string{return this.API_URL + '/owned'}
  public static get API_KEY():string {return 'AIzaSyBfeYjfXYq_kccfOb-wRPnRw5f_ED5hpaA'}
  public static get CheckOwnedBook():string {return this.API_URL + '/owned/check'}
